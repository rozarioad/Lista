sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("undefined/RelatorioClientes/app", ".html");
		...
		return Opa5.extend(".RelatorioClientes.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["undefined/RelatorioClientes/localService/mockserver"], function (mockserver) {
